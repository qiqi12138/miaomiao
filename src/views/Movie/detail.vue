<template>
    <div id="detailContrainer" class="slide-enter-active">
		...
		<div v-else="isLoading" id="content" class="contentDetail">
...
<style scoped>
#detailContrainer { position: absolute; left: 0; top: 0; z-index: 100; width: 100%; min-height: 100%; background-color: #fff; }
